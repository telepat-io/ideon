...
describe('pipeline runner', () => {
  ...
  it('re-renders images when resumed session has corrupted or missing image files', async () => {
    ...
    config: {
            ...
            secrets: { openRouterApiKey: null, replicateApiToken: null, googleAdsDeveloperToken: null, googleAdsClientId: null, googleAdsClientSecret: null, googleAdsRefreshToken: null, googleAdsCustomerId: null, googleAdsLoginCustomerId: null },
          },
        },
        {
          dryRun: true,
