...
1. Plan generates cover image description and inline image descriptions (count proportional to article length: 0–1 for small, 1–2 for medium, 2–4 for large), each with explicit `anchorAfterSection` placement starting at section 2
